...
Для вывода эмодзи в Markdown вы можете использовать скопированные эмодзи из интернета (т. е. вставить в файл прямо как символ), Unicode-символы или встроенные эмодзи.
